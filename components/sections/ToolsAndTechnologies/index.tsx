...
const ToolsAndTechnologies: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full gap-16 bg-theme-base/30 py-4 backdrop-blur-sm lg:hidden">
        <h2 className="mr-4 inline-block w-max text-3xl font-bold text-theme-contrary">
          Tools.
        </h2>

        <motion.span
          className="relative top-0 inline-block h-full rounded-full bg-gradient-to-t from-apple-purple to-apple-pink"
          style={{ width }}
        ></motion.span>
      </header>

      <div
        className="mx-auto mt-64 grid w-full max-w-5xl gap-32"
        ref={sectionRef}
      >
