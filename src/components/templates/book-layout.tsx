    ...
    return (
        <div>
            <section className="mx-auto flex flex-col items-center justify-center pt-12">
                ...
                <div className="mx-auto my-16 grid max-w-(--breakpoint-sm) gap-4 px-4 text-center">
                    <Blockquote>{summaryQuote}</Blockquote>
                </div>
            </section>

            <div className="space-y-32">
                <section className="mx-auto max-w-(--breakpoint-sm) px-4" id="introduction">
                    <h1 className="mb-4 border-b pb-4 text-4xl font-bold text-foreground">
                        {title}
                    </h1>
                    <p>
                        by
            ...
            <span>
              reviewed at <i>{released}</i>
                        ...
                        <span className="rounded-full bg-primary p-2 text-xs text-white">
              Recommended read
            </span>
                    </p>
                ...
                <section
                    className="relative mx-auto max-w-(--breakpoint-sm) px-4"
                    id="learnings"
                >
                    <h2 className="sticky top-[4.75rem] mb-6 border-b  bg-background py-3">
                ...
                <section className="mx-auto max-w-(--breakpoint-sm) px-4" id="outcome">
                    <h2 className="sticky top-[4.75rem] mb-6 border-b  bg-background py-3">
                ...
                {furtherReading && (
                    <section className="mx-auto max-w-(--breakpoint-sm) px-4">
                        <Divider/>
                        {furtherReading}
                    </section>
                )}
