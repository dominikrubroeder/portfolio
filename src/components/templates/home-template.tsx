...
export function HomeTemplate() {
  ...
  return (
    <>
      ...
      <div className="mx-auto mb-6 max-w-(--container) bg-primary px-4 pb-4 text-4xl leading-[1.1] font-black text-primary-foreground xs:text-7xl sm:mb-8 sm:text-9xl sm:leading-none">
