...
export default function WebStorm({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 128 128"
      fill="none"
      ...
      <g clipPath="url(#clip0_748_1013)">
        <g clipPath="url(#clip1_748_1013)">
          <path
            ...
            fill="url(#paint0_linear_748_1013)"
          />
          <path
