  ...
  return (
    <button
      className={cn(
        ...
        type === 'Outline' &&
          'relative rounded-xl py-2 text-accent transition-all after:absolute after:inset-3 after:-inset-x-3 after:inset-y-1 after:-z-10 after:rounded-2xl after:bg-muted after:transition-all hover:after:bg-muted-hover',
        type === 'Plain' &&
          'relative rounded-xl py-2 text-accent transition-all after:absolute after:inset-3 after:inset-y-1 after:-z-10 after:rounded-2xl after:bg-transparent after:transition-all hover:after:-inset-x-3 hover:after:bg-muted',
