  ...
  return (
    <button
      className={cn(
        'w-max',
        type === 'Contained' &&
          'relative rounded-xl py-2 text-white transition-all after:absolute after:inset-3 after:-inset-x-3 after:inset-y-1 after:-z-10 after:rounded-2xl after:bg-accent-700 after:transition-all hover:after:bg-accent-900',
        type === 'Outline' &&
