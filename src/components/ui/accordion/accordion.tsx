...
export default function Accordion({
  ...
  return (
    <div ref={ref} className="pt-4">
      <div
        className="sticky top-4 z-10 mx-auto flex cursor-pointer select-none items-center justify-between gap-4 rounded-2xl bg-gray-5 px-4 py-3 leading-[1.6] text-violet-400 transition hover:bg-gray-4 md:relative md:top-0"
