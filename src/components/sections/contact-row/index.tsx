...
export default function ContactRow() {
  return (
    <div className="mx-auto mt-4 flex w-full max-w-screen-sm items-center justify-center gap-4 border-t border-gray-5 py-4 text-center md:mt-8 md:py-8">
      ...
      <button className="relative flex items-center gap-2 rounded-2xl px-4 py-3 transition after:absolute after:inset-0 after:z-0 after:scale-75 after:rounded-lg after:bg-gray-5 after:opacity-0 after:transition after:content-[''] hover:after:scale-100 hover:after:rounded-xl hover:after:opacity-100">
