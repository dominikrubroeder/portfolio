...
export function Sidebar({
  ...
  return (
    <>
      <aside
        className={cn(
          'fixed top-2 right-2 z-max h-[97svh] min-w-40 scrollbar-none overflow-y-auto border bg-background [html[data-theme=default]_&]:rounded-2xl [html[data-theme=default]_&]:transition-all',
          isOpen
