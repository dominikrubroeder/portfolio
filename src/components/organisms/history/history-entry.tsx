...
export default function HistoryEntry({
  ...
  return (
    <div className="relative flex gap-4">
      <button
        className={clsx(
          'absolute top-16 -left-11 flex flex-none shrink-0 items-center justify-center self-start rounded-full p-4 transition',
          isCurrent ? 'bg-primary text-violet-200' : 'bg-muted'
        )}
        onClick={toggle}
      >
        <ChevronUpIcon
