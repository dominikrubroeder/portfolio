  ...
  return (
    <div className={cn('mx-auto w-full max-w-screen-sm space-y-6', className)}>
      ...
      <ul className="mb-5 list-disc pl-8">
        ...
        <li>
          Pen and Paper: Fast sketching and scribbling can improve visualizing
          my ideas faster. I can also turn back to them later, when something
          else blocks the opportunity working on it immediately
        </li>
        <li>
          Notes: Similar to Pen and Paper work, it will help my brain to
