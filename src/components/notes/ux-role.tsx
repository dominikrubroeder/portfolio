...
export default function UxRole() {
  return (
    <Accordion title="What is an UX Engineer?">
      ...
      <p>
        The Bridge between Design and Development. Can also be the combo package
        itself, a Designer which is capable of developing his thoughts, layouts
        and concepts. Strong at coding, design and architecture.
      </p>
      ...
      <p>
        ...
        is. The tools are just a way of making the concept <i>visual</i> and{' '}
        <i>visible</i>.
      </p>
