...
export default function ToolSearch({ placeholder }: { placeholder: string }) {
  ...
  return (
    <div className="relative flex flex-1 shrink-0">
      ...
      <input
        className="peer block h-11 w-full rounded-md border bg-background py-2 pl-10 font-semibold text-foreground placeholder:font-normal placeholder:text-muted-foreground focus:border-muted focus:outline-none"
