...
export function ViteJsLogo({ className }: LogoProps) {
  return (
    <svg
      viewBox="0 0 128 129"
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_1156_3294)">
        <path
          ...
          fill="url(#paint0_linear_1156_3294)"
        />
        <path
          ...
          fill="url(#paint1_linear_1156_3294)"
        />
      </g>
      <defs>
        <linearGradient
          id="paint0_linear_1156_3294"
          x1="-1.05875"
          y1="10.5923"
          x2="73.6812"
          y2="112.095"
