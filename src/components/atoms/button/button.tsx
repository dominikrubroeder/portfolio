...
export function Button({
  ...
  const classNames = cn(
    ...
    size === 'tiny' &&
      'min-h-6 min-w-6 rounded-lg hover:rounded-md text-xs py-1 px-1 gap-2 [&>svg]:size-3.5',
    size === 'small' &&
      ' min-h-8 min-w-8 rounded-xl hover:rounded-lg text-sm py-1 px-2 gap-2 [&>svg]:size-3.5',
    size === 'medium' &&
      'min-h-11 min-w-11 rounded-2xl hover:rounded-xl text-base py-2 px-3 gap-2 [&>svg]:size-5',
    size === 'large' &&
      'min-h-11 min-w-11 rounded-2xl hover:rounded-xl text-lg py-2 px-3 gap-3 [&>svg]:size-6',
