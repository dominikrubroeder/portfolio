...
export default function Header() {
    return (
        <header
            id="header"
            className="sticky top-0 z-max mx-auto flex max-w-(--breakpoint-xl) items-center justify-between gap-4 border-b bg-background p-4 sm:py-3 md:relative md:py-4 xl:px-0"
        >
