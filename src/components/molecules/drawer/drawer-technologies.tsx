...
export function DrawerTechnologies({
  drawerTriggerLabel
}: {
  ...
  return (
    <Drawer showSwipeHandle>
      <DrawerTrigger
        render={
          <Button
            ...
            aria-label="Open more technologies ..."
          >
      ...
      <DrawerContent>
        <DrawerHeader>
          <DrawerTitle>More technologies I've worked with</DrawerTitle>
          <DrawerDescription className="sr-only">
            More technologies I've worked with during the last years
          </DrawerDescription>
        </DrawerHeader>
