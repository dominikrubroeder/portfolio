...
export function AccordionItemContained({
  ...
  return (
    <div ref={ref} className={cn('relative space-y-3 pt-4', className)}>
      <ButtonGroup className="group sticky top-22 mx-auto flex items-center justify-between gap-4 lg:top-4">
        {isOpen && (
